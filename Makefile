...
_DEPS = instruction_set.h memory.h uthash.h shared.h symbol_table.h registers.h wam.h main.h
DEPS = $(patsubst %,$(IDIR)/%,$(_DEPS))


_OBJ = instruction_set.o memory.o shared.o symbol_table.o registers.o wam.o main.o
